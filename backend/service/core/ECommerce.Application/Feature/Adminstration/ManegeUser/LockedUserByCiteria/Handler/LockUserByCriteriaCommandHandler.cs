...
namespace ECommerce.Application.Feature.Adminstration.ManegeUser.LockedUserByCiteria.Handler
{
    ...
    { 
        ...
        public LockUserByCriteriaCommandHandler(IUnitOfWork unitOfWork)
          {
              ...
              try
                ...
                if (admin.userType != UserType.Admin)
                  ...
                  var targetUser = await _unitOfWork.Users.GetUserByCriteria(
                    ...
                    {
                        return Result<UserDto>.Failure(Error.NotFound("User.NotFound", "The user you are trying to Locked does not exist."));
                    }

                    targetUser.MarkAsLock();
