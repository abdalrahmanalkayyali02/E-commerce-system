...
namespace ECommerce.Application.Feature.Adminstration.ManegeShop.MarkAsViewSellerDocument.Handler
{
    public sealed class MarkAsViewSellerDocumentCommandHandler : IRequestHandler<MarkAsViewSellerDocumentCommand, Result<bool>>
    {
        private readonly IUnitOfWork _unitOfWork;

        public MarkAsViewSellerDocumentCommandHandler(IUnitOfWork unitOfWork)
        {
        ...
        public async Task<Result<bool>> Handle(MarkAsViewSellerDocumentCommand command, CancellationToken cancellationToken)
        {
            try
            {
                ...
                sellerExist.markAsViewForSellerDocument();
